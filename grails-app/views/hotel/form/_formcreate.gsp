...
<div class="dialog">
    <div class="row">
        <label for="name">
            ...
            <g:textField type="text" id="name" name="name" required="required" value="${fieldValue(bean:hotel,field:'name')}" placeholder="Введите название отеля"/>
        </label>
    </div>
    <div class="row">
        <label for="country">
    ...
    <div class="row">
        <label for="website">
            ...
            <g:textField id="website" name="website" value="${fieldValue(bean:hotel,field:'website')}" placeholder="Введите веб-сайт"/>
        </label>
    </div>
    <div class="row">
        <label for="rating">
            <div class="name">Рейтинг <span>*</span></div>
            <input type="hidden" id="rating" name="rating" required="required" value="${fieldValue(bean:hotel,field:'rating')}">
